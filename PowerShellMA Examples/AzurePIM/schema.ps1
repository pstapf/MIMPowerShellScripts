...
$obj | add-member -type noteproperty -name "ReferenceKey|String" -Value "ReferenceKey"
$obj | add-member -type noteproperty -name "ReferenceSystem|String" -Value "ReferenceSystem"
$obj
